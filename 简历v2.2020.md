...
[多页面脚手架mpa-starter](https://github.com/lingobus/mpa-starter) : 解决方案：
1. 国际化
2. lazyload
3. 移动端屏幕适配
4. 登陆、注册
...
[pug webpack插件](https://github.com/lingobus/pug-webpack-plugin) :参考html-webpack-plugin，支持pug的extend
